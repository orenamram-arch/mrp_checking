...
with TABS[0]:
    ...
    if not dash_df.empty and len(dash_df) > 0:
        ...
        st.success("🎉 אין חוסרים אמיתיים ב-MRP עבור ההגדרות והסינונים שנבחרו!")
...
with TABS[2]:
    ...
    with col_res1:
        ...
        if freed_assemblies:
            ...
            st.info("אין הרכבות שעוברות ממצב חסום למוכנות מלאה בעקבות התוספת הזו.")
